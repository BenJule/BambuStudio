                  ...
                  <td className={tableBodyCellClass}>
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex flex-col gap-[2px] min-w-0">
                        ...
                        {s.note && (
                          <div className="flex items-center gap-1 text-xs text-fm-text-detail leading-[19px] min-w-0">
                            <svg className="shrink-0 w-3 h-3 opacity-60" viewBox="0 0 12 12" fill="none">
